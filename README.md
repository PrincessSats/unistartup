...
| **Обучение** | Курсы → модули → уроки → задачи. Прогресс на пользователя |
...
- **Managed PostgreSQL** — `mdb.yandexcloud.net:6432` (через PgBouncer)
- **Managed Redis**
...
- **Docker** — образ на `python:3.11-slim`, порт 8080
