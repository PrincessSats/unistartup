...
export default function MobileBlock() {
  const handleRequestDesktop = () => {
    // Попытка открыть подсказку десктопной версии — большинство мобильных браузеров это поддерживают
    ...
    >
      ...
      <div className="mt-14 w-full flex justify-center">
        ...
        >
          ...
          {/* Полоса главного экрана */}
          <rect x="202" y="156" width="20" height="4" rx="2" fill="#3D3560" />

          {/* Значок "без мобильной версии" на телефоне */}
