...
export default function HacknetLogo({ className = 'w-12 h-12', alt = 'HackNet' }) {
  ...
  return (
    ...
    >
      <path d="M0 12C0 5.37258 5.37258 0 12 0H36C42.6274 0 48 5.37258 48 12V36C48 42.6274 42.6274 48 36 48H12C5.37258 48 0 42.6274 0 36V12Z" fill={`url(#${gradientId})`} />
      ...
      <defs>
        <linearGradient id={gradientId} x1="0.84" y1="54.5455" x2="48.9103" y2="53.0385" gradientUnits="userSpaceOnUse">
