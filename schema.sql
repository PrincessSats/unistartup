...
CREATE TABLE kb_entries (
    ...
    ru_summary      TEXT,
    ru_explainer    TEXT,
    tags            TEXT[] DEFAULT '{}',  -- ['web','xss','cve-2024-...']
    difficulty      INTEGER,
    created_at      TIMESTAMPTZ NOT NULL DEFAULT now()
);
...
CREATE TABLE tasks (
    id                      BIGSERIAL PRIMARY KEY,
    title                   TEXT NOT NULL,
    category                TEXT NOT NULL,       -- 'web','pwn','crypto','re','forensics',...
...
CREATE TABLE task_flags (
    ...
    format          TEXT NOT NULL,   -- 'FLAG{...}'
    expected_value  TEXT,            -- можно NULL на этапе draft
    description     TEXT,
...
CREATE TABLE task_materials (
    id              BIGSERIAL PRIMARY KEY,
    task_id         BIGINT NOT NULL REFERENCES tasks(id) ON DELETE CASCADE,
    type            TEXT NOT NULL, -- 'file','service','credentials','other'
    name            TEXT NOT NULL,
    description     TEXT,
...
CREATE TABLE courses (
    id              BIGSERIAL PRIMARY KEY,
    code            TEXT NOT NULL UNIQUE,  -- 'cyber-basic', 'python-101'
    title           TEXT NOT NULL,
    description     TEXT,
...
CREATE TABLE llm_generations (
    id              BIGSERIAL PRIMARY KEY,
    model           TEXT NOT NULL,       -- 'yandexgpt-lite', 'qwen', 'our-small-llm'
